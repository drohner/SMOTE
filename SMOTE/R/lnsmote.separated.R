lnsmote.separated <-
function(data, minority, k = 5, o = 1, method = "e", seed = 321, cores = 2){
  #Check Input
  .checkinput_ln(nrow(data),k, o, seed)
  .checkinput_ln_sep(data, minority)
  ...
  synthetic = .lnsmote(data, nrow(minority), k, o, method, seed, cores)  
...
# Checks the given input on validity
.checkinput_ln_sep = function(data, minority){
